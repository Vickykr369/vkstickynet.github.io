...
contactBtn.addEventListener('click', () => {
    main_frm.style.opacity = "100"
    main_frm.style.transform = 'scale(1)'
...
close_form.addEventListener('click', () => {
    main_frm.style.transform = 'scale(0)'
    main_frm.style.opacity = "0"
...
contactforPhone.addEventListener('click', () => {
    ...
    main_frm.style.opacity = "100"
    developertab.style.backgroundColor = "rgba(6, 212, 6, 0.938)"
    managertab.style.backgroundColor = "white"
